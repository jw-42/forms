...
var fontFamilyFallbacks = 'apple-system, system-ui, "Helvetica Neue", Arial, sans-serif';
...
exports.lightTheme = __assign(__assign(__assign({}, exports.lightThemeBase), common_1.helpers), { colors: __assign(__assign({}, exports.lightThemeBase.colors), { colorRating: '#ffd400', colorButtonContrastAlpha: {
    ...
    fontH0: {
        regular: {
            fontSize: 28,
            lineHeight: 32,
            fontFamily: (0, tokenHelpers_1.staticRef)(exports.lightThemeBase.fontFamilyAccent),
            fontWeight: (0, tokenHelpers_1.staticRef)(exports.lightThemeBase.fontWeightAccent1),
        },
        compact: {
            fontSize: 44,
            lineHeight: 52,
    ...
    // остальное
    toneValueOverlay: 0.48, toneValueViewer: 0.88, toneValueToolbar: 0.24, toneValueHover: 0.04, toneValueActive: 0.08, toneValueFocus: 0.08, typeBorderButton: 'solid', typeBorderPosition: 'inset' });
exports.darkThemeElevation = {
