$theme-name: 'vkAccessibilityIOSDark';
...
$color-text-secondary--hover: #949698;
$color-text-secondary--active: #999B9D;
...
$color-text-subhead: #B9BABF;
$color-text-subhead--hover: #BCBDC2;
$color-text-subhead--active: #BFC0C4;
$color-text-tertiary: #6B6D6F;
$color-text-tertiary--hover: #717375;
$color-text-tertiary--active: #77797B;
...
$color-icon-medium: #B9BABF;
$color-icon-medium--hover: #BCBDC2;
$color-icon-medium--active: #BFC0C4;
$color-icon-medium-alpha: rgba(247, 248, 255, 70%);
$color-icon-medium-alpha--hover: rgba(247, 248, 255, 0.74);
$color-icon-medium-alpha--active: rgba(247, 248, 255, 0.78);
$color-icon-secondary: #898B8D;
$color-icon-secondary--hover: #8E9092;
$color-icon-secondary--active: #929496;
$color-icon-secondary-alpha: rgba(248, 252, 255, 50%);
$color-icon-secondary-alpha--hover: rgba(248, 252, 255, 0.54);
$color-icon-secondary-alpha--active: rgba(248, 252, 255, 0.58);
$color-icon-tertiary: #5D5F61;
$color-icon-tertiary--hover: #636567;
$color-icon-tertiary--active: #6A6C6E;
$color-icon-tertiary-alpha: rgba(246, 250, 255, 37%);
$color-icon-tertiary-alpha--hover: rgba(246, 250, 255, 0.41000000000000003);
$color-icon-tertiary-alpha--active: rgba(246, 250, 255, 0.45);
...
$color-search-field-background: #2A2A2B;
$color-search-field-background--hover: #333333;
$color-search-field-background--active: #3B3B3C;
