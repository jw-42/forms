:root {
	--vkui--theme_name: 'dobroDark';
	--vkui--theme_name_base: 'dobro';
	...
	--vkui--dobro_font_family600: VK Sans Display, sans-serif, Arial;
	--vkui--dobro_font_family500: VK Sans Display Medium, sans-serif, Arial;
	--vkui--dobro_font_family400: VK Sans Display Regular, sans-serif, Arial;
	--vkui--dobro_portal_z_index: 96px;
	--vkui--dobro_popout_z_index: 96px;
	--vkui--dobro_modal_z_index: 97px;
	--vkui--dobro_menu_z_index: 98px;
	--vkui--theme_inherits_from: 'dobro';
...
:root {
	...
	--vkui--font_display_title1--font_family: -apple-system, system-ui, "Helvetica Neue", Roboto, sans-serif;
	--vkui--font_display_title1--font_weight: 600;
	...
	--vkui--font_display_title3--font_family: -apple-system, system-ui, "Helvetica Neue", Roboto, sans-serif;
	--vkui--font_display_title3--font_weight: 600;
	--vkui--font_display_title4--font_size: 17px;
	--vkui--font_display_title4--line_height: 22px;
	--vkui--font_display_title4--font_family: -apple-system, system-ui, "Helvetica Neue", Roboto, sans-serif;
	--vkui--font_display_title4--font_weight: 600;
	--vkui--font_title1--font_size: 24px;
	--vkui--font_title1--line_height: 28px;
	--vkui--font_title1--font_family: -apple-system, system-ui, "Helvetica Neue", Roboto, sans-serif;
	--vkui--font_title1--font_weight: 600;
	--vkui--font_title2--font_size: 20px;
	--vkui--font_title2--line_height: 24px;
	--vkui--font_title2--font_family: -apple-system, system-ui, "Helvetica Neue", Roboto, sans-serif;
	--vkui--font_title2--font_weight: 600;
	--vkui--font_title3--font_size: 17px;
	--vkui--font_title3--line_height: 22px;
	--vkui--font_title3--font_family: -apple-system, system-ui, "Helvetica Neue", Roboto, sans-serif;
	--vkui--font_title3--font_weight: 600;
	...
	--vkui--font_paragraph--font_family: -apple-system, system-ui, "Helvetica Neue", Roboto, sans-serif;
	...
	--vkui--font_footnote--line_height: 16px;
	--vkui--font_footnote--font_family: -apple-system, system-ui, "Helvetica Neue", Roboto, sans-serif;
	--vkui--font_footnote--font_weight: 400;
	--vkui--font_footnote_caps--font_size: 13px;
	--vkui--font_footnote_caps--line_height: 16px;
	--vkui--font_footnote_caps--font_family: -apple-system, system-ui, "Helvetica Neue", Roboto, sans-serif;
	--vkui--font_footnote_caps--font_weight: 600;
	--vkui--font_footnote_caps--text_transform: uppercase;
	--vkui--font_caption1--font_size: 12px;
	--vkui--font_caption1--line_height: 14px;
	--vkui--font_caption1--font_family: -apple-system, system-ui, "Helvetica Neue", Roboto, sans-serif;
	--vkui--font_caption1--font_weight: 400;
	--vkui--font_caption1_caps--font_size: 12px;
	--vkui--font_caption1_caps--line_height: 14px;
	--vkui--font_caption1_caps--font_family: -apple-system, system-ui, "Helvetica Neue", Roboto, sans-serif;
	--vkui--font_caption1_caps--font_weight: 600;
	--vkui--font_caption1_caps--text_transform: uppercase;
	--vkui--font_caption2--font_size: 11px;
	--vkui--font_caption2--line_height: 14px;
	--vkui--font_caption2--font_family: -apple-system, system-ui, "Helvetica Neue", Roboto, sans-serif;
	--vkui--font_caption2--font_weight: 400;
	--vkui--font_caption2_caps--font_size: 11px;
	--vkui--font_caption2_caps--line_height: 14px;
	--vkui--font_caption2_caps--font_family: -apple-system, system-ui, "Helvetica Neue", Roboto, sans-serif;
	--vkui--font_caption2_caps--font_weight: 600;
	--vkui--font_caption2_caps--text_transform: uppercase;
	--vkui--font_caption3--font_size: 9px;
	--vkui--font_caption3--line_height: 12px;
	--vkui--font_caption3--font_family: -apple-system, system-ui, "Helvetica Neue", Roboto, sans-serif;
	--vkui--font_caption3--font_weight: 400;
	--vkui--font_caption3_caps--font_size: 9px;
	--vkui--font_caption3_caps--line_height: 12px;
	--vkui--font_caption3_caps--font_family: -apple-system, system-ui, "Helvetica Neue", Roboto, sans-serif;
	--vkui--font_caption3_caps--font_weight: 600;
	...
	--vkui--size_button_padding_horizontal: 12px;
	...
	--vkui--size_cardgrid_padding: 8px;
	--vkui--size_card_border_radius: 8px;
...
@media (min-width: 1004px) and (max-width: 1243px) {
