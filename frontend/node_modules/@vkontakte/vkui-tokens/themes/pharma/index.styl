...
$vkui-color-background-accent = #1DD3A2;
$vkui-color-background-accent--hover = #1CCB9E;
$vkui-color-background-accent--active = #1BC39A;
...
$vkui-color-text-accent = #1DD3A2;
$vkui-color-text-accent--hover = #1CCB9E;
$vkui-color-text-accent--active = #1BC39A;
...
$vkui-color-icon-accent = #1DD3A2;
$vkui-color-icon-accent--hover = #1CCB9E;
$vkui-color-icon-accent--active = #1BC39A;
...
$vkui-color-stroke-accent = #1DD3A2;
$vkui-color-stroke-accent--hover = #1CCB9E;
$vkui-color-stroke-accent--active = #1BC39A;
...
$vkui-color-sale = #eb1981;
$vkui-color-sale--hover = #E2197E;
$vkui-color-sale--active = #D8187C;
...
vkui-media-font-media-feature-title--regular() {
	font-family: VKSansDisplay, MailSans, Inter, Helvetica, Arial, sans-serif;
	font-weight: 700;
	font-size: 20px;
	line-height: 26px;
...
vkui-media-font-media-feature-title--compact() {
	font-family: VKSansDisplay, MailSans, Inter, Helvetica, Arial, sans-serif;
	font-weight: 700;
	font-size: 32px;
	line-height: 40px;
...
vkui-media-font-media-feature-title--compact-x() {
	font-family: VKSansDisplay, MailSans, Inter, Helvetica, Arial, sans-serif;
	font-weight: 700;
	font-size: 28px;
	line-height: 36px;
...
vkui-media-font-media-title1-tiny--regular() {
	font-family: VKSansDisplay, MailSans, Inter, Helvetica, Arial, sans-serif;
	font-weight: 500;
	font-size: 30px;
	line-height: 36px;
...
vkui-media-font-media-title1-tiny--compact() {
	font-family: VKSansDisplay, MailSans, Inter, Helvetica, Arial, sans-serif;
	font-weight: 500;
	font-size: 40px;
	line-height: 48px;
...
vkui-media-font-media-title2-tiny--regular() {
	font-family: VKSansDisplay, MailSans, Inter, Helvetica, Arial, sans-serif;
	font-weight: 500;
	font-size: 26px;
	line-height: 32px;
...
vkui-media-font-media-title2-tiny--compact() {
	font-family: VKSansDisplay, MailSans, Inter, Helvetica, Arial, sans-serif;
	font-weight: 500;
	font-size: 32px;
	line-height: 40px;
...
vkui-media-font-media-title4--regular() {
	font-family: VKSansDisplay, MailSans, Inter, Helvetica, Arial, sans-serif;
	font-weight: 500;
	font-size: 24px;
	line-height: 30px;
...
vkui-media-font-media-title4--compact() {
	font-family: VKSansDisplay, MailSans, Inter, Helvetica, Arial, sans-serif;
	font-weight: 500;
	font-size: 28px;
	line-height: 36px;
...
vkui-media-font-media-title5--regular() {
	font-family: VKSansDisplay, MailSans, Inter, Helvetica, Arial, sans-serif;
	font-weight: 500;
	font-size: 22px;
	line-height: 28px;
...
vkui-media-font-media-title5--compact() {
	font-family: VKSansDisplay, MailSans, Inter, Helvetica, Arial, sans-serif;
	font-weight: 500;
	font-size: 24px;
	line-height: 32px;
...
vkui-media-font-media-title6--regular() {
	font-family: VKSansDisplay, MailSans, Inter, Helvetica, Arial, sans-serif;
	font-weight: 500;
	font-size: 20px;
	line-height: 26px;
...
vkui-media-font-media-title6--compact() {
	font-family: VKSansDisplay, MailSans, Inter, Helvetica, Arial, sans-serif;
	font-weight: 500;
	font-size: 22px;
	line-height: 28px;
...
vkui-media-font-media-subtitle-light--regular() {
	font-family: VKSansDisplay, MailSans, Inter, Helvetica, Arial, sans-serif;
	font-weight: 400;
	font-size: 20px;
	line-height: 26px;
...
vkui-media-font-media-quote--regular() {
	font-family: VKSansDisplay, MailSans, Inter, Helvetica, Arial, sans-serif;
	font-weight: 500;
	font-size: 18px;
	line-height: 26px;
...
vkui-media-font-media-quote--compact() {
	font-family: VKSansDisplay, MailSans, Inter, Helvetica, Arial, sans-serif;
	font-weight: 500;
	font-size: 24px;
	line-height: 36px;
...
vkui-media-font-media-quote-person--regular() {
	font-family: VKSansDisplay, MailSans, Inter, Helvetica, Arial, sans-serif;
	font-weight: 600;
	font-size: 18px;
	line-height: 24px;
...
vkui-media-font-media-quote-person--compact() {
	font-family: VKSansDisplay, MailSans, Inter, Helvetica, Arial, sans-serif;
	font-weight: 600;
	font-size: 24px;
	line-height: 32px;
...
vkui-media-font-media-paragraph-secondary--regular() {
	font-weight: 400;
	font-size: 16px;
	line-height: 24px;
}
vkui-media-font-media-paragraph-numbering--regular() {
	font-family: Inter, Helvetica, Arial, sans-serif;
	font-weight: 700;
	font-size: 16px;
	line-height: 28px;
...
vkui-media-font-media-paragraph-numbering--compact() {
	font-family: Inter, Helvetica, Arial, sans-serif;
	font-weight: 700;
	font-size: 18px;
	line-height: 32px;
...
vkui-media-font-media-text-secondary-light--regular() {
	font-family: VKSansDisplay, MailSans, Inter, Helvetica, Arial, sans-serif;
	font-weight: 400;
	font-size: 15px;
	line-height: 20px;
}
vkui-media-font-media-caption--regular() {
	font-weight: 400;
	font-size: 14px;
	line-height: 22px;
}
vkui-media-font-media-caption--compact() {
	font-weight: 400;
	font-size: 16px;
	line-height: 26px;
}
vkui-media-font-media-caption-caps--regular() {
	font-weight: 400;
	font-size: 13px;
	line-height: 16px;
	letter-spacing: 0.05em;
}
vkui-media-font-media-caption-caps--compact() {
	font-weight: 400;
	font-size: 15px;
	line-height: 20px;
	letter-spacing: 0.05em;
