:root {
	...
	--vkui--home_color_social_vk--hover: #308CF5;
	--vkui--home_color_social_vk--active: #3891F6;
	--vkui--home_color_social_ok: #EE8208;
	--vkui--home_color_social_ok--hover: #EF8712;
	--vkui--home_color_social_ok--active: #EF8C1C;
	--vkui--home_color_social_fb: #0561AF;
	--vkui--home_color_social_fb--hover: #0F67B2;
	--vkui--home_color_social_fb--active: #196EB5;
	--vkui--home_color_filin_fail_primary: #333333;
	--vkui--home_color_filin_fail_primary--hover: #3B3B3B;
	--vkui--home_color_filin_fail_primary--active: #434343;
	--vkui--home_color_filin_fail_secondary: #C7C7C7;
	--vkui--home_color_filin_fail_secondary--hover: #C9C9C9;
	--vkui--home_color_filin_fail_secondary--active: #CBCBCB;
}
