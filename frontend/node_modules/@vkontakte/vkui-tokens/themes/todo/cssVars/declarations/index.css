:root {
	...
	--vkui--elevation2: 0 2px 0 0 rgba(0,16,61, 0.04);
	--vkui--elevation3: 0 4px 32px rgba(0, 16, 61, 0.24);
	--vkui--elevation4: 0 16px 48px 0 rgba(0,16,61, 0.48);
