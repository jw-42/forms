:root {
	...
	--vkui--theme_name_base: 'home';
	--vkui--home_font_family_default: Helvetica, Arial, sans-serif;
	--vkui--home_font_weight_normal: 400;
	--vkui--home_font_weight_bold: 700;
	...
	--vkui--home_color_social_vk: #2787F5;
	--vkui--home_color_social_vk--hover: #2582EE;
	--vkui--home_color_social_vk--active: #247DE6;
	--vkui--home_color_social_ok: #EE8208;
	--vkui--home_color_social_ok--hover: #E47D0A;
	--vkui--home_color_social_ok--active: #DB790C;
	--vkui--home_color_social_fb: #0561AF;
	--vkui--home_color_social_fb--hover: #055EAA;
	--vkui--home_color_social_fb--active: #055BA6;
	--vkui--home_color_filin_fail_primary: #333333;
	--vkui--home_color_filin_fail_primary--hover: #313233;
	--vkui--home_color_filin_fail_primary--active: #2F3034;
	--vkui--home_color_filin_fail_secondary: #C7C7C7;
	--vkui--home_color_filin_fail_secondary--hover: #BFC0C1;
	--vkui--home_color_filin_fail_secondary--active: #B7B8BC;
}
