:root {
	--vkui--theme_name: 'workspaceAdmin';
	...
	--vkui--font_headline3--font_family--regular: VKSansDisplay, MailSans, apple-system, system-ui, "Helvetica Neue", Arial, sans-serif;
	...
	--vkui--color_background: #F6F7F8;
	--vkui--color_background--hover: #ECEEF1;
	--vkui--color_background--active: #E2E5E9;
	...
	--vkui--color_background_tertiary_alpha: rgba(58, 58, 90, 0.04);
	--vkui--color_background_tertiary_alpha--hover: rgba(58, 58, 90, 0.08);
	--vkui--color_background_tertiary_alpha--active: rgba(58, 58, 90, 0.12);
	...
	--vkui--color_background_negative_tint--hover: #FDE2E7;
	--vkui--color_background_negative_tint--active: #FCD8DF;
	...
	--vkui--color_text_secondary: #797A80;
	--vkui--color_text_secondary--hover: #74767D;
	--vkui--color_text_secondary--active: #6F727B;
	...
	--vkui--color_icon_negative: #ED033A;
	--vkui--color_icon_negative--hover: #E4043A;
	--vkui--color_icon_negative--active: #DA043A;
	...
	--vkui--color_stroke_negative--active: #DA0A35;
	...
	--vkui--color_background_accent_tint_themed--hover: #E5F1FF;
	--vkui--color_background_accent_tint_themed--active: #DBECFF;
	...
	--vkui--color_background_warning_tint_alpha: rgba(255, 241, 173, 0.64);
	--vkui--color_background_warning_tint_alpha--hover: rgba(255, 241, 173, 0.72);
	--vkui--color_background_warning_tint_alpha--active: rgba(255, 241, 173, 0.76);
	...
	--vkui--color_background_negative_tint_themed_alpha: rgba(237, 10, 52, 0.1);
	--vkui--color_background_negative_tint_themed_alpha--hover: rgba(237, 10, 52, 0.14);
	...
	--vkui--color_background_negative_tint_themed--hover: #FDE2E7;
	--vkui--color_background_negative_tint_themed--active: #FCD8DF;
	...
	--vkui--color_background_positive_tint_alpha: rgba(13, 194, 104, 0.12);
	...
	--vkui--color_avatars_blue: #4C91FF;
	--vkui--color_avatars_blue--hover: #498CF7;
	--vkui--color_avatars_blue--active: #4687EF;
	--vkui--color_avatars_coral: #FEA4A4;
	--vkui--color_avatars_coral--hover: #F49EA0;
	--vkui--color_avatars_coral--active: #EA989C;
	--vkui--color_avatars_green: #43CC4C;
	--vkui--color_avatars_green--hover: #40C44B;
	--vkui--color_avatars_green--active: #3EBD4B;
	--vkui--color_avatars_indigo: #7772F8;
	--vkui--color_avatars_indigo--hover: #726EF1;
	--vkui--color_avatars_indigo--active: #6D6AE9;
	--vkui--color_avatars_lavender: #D3B2FF;
	--vkui--color_avatars_lavender--hover: #CBACF7;
	--vkui--color_avatars_lavender--active: #C2A5EF;
	--vkui--color_avatars_lime: #C3F07F;
	--vkui--color_avatars_lime--hover: #BBE77C;
	--vkui--color_avatars_lime--active: #B3DE7A;
	--vkui--color_avatars_mint: #7BEADB;
	--vkui--color_avatars_mint--hover: #76E1D5;
	--vkui--color_avatars_mint--active: #71D9CE;
	--vkui--color_avatars_orange: #F68E42;
	--vkui--color_avatars_orange--hover: #EC8942;
	--vkui--color_avatars_orange--active: #E28442;
	--vkui--color_avatars_peach: #FFB980;
	--vkui--color_avatars_peach--hover: #F5B27D;
	--vkui--color_avatars_peach--active: #EBAB7B;
	--vkui--color_avatars_red: #F55252;
	--vkui--color_avatars_red--hover: #EB4F51;
	--vkui--color_avatars_red--active: #E14D50;
	--vkui--color_avatars_sea: #22CEEC;
	--vkui--color_avatars_sea--hover: #21C6E5;
	--vkui--color_avatars_sea--active: #1FBFDE;
	--vkui--color_avatars_seagreen: #42D7A5;
	--vkui--color_avatars_seagreen--hover: #3FCFA1;
	--vkui--color_avatars_seagreen--active: #3DC79D;
	--vkui--color_avatars_sky: #9EDBFF;
	--vkui--color_avatars_sky--hover: #98D3F7;
	--vkui--color_avatars_sky--active: #91CBEF;
	--vkui--color_avatars_violet: #B884FF;
	--vkui--color_avatars_violet--hover: #B17FF7;
	--vkui--color_avatars_violet--active: #A97BEF;
	--vkui--color_avatars_yellow: #FFD65C;
	--vkui--color_avatars_yellow--hover: #F5CE5B;
	--vkui--color_avatars_yellow--active: #EBC65A;
	--vkui--color_icon_negative_snackbar: #FF5C5C;
	--vkui--color_icon_negative_snackbar--hover: #F5595B;
	--vkui--color_icon_negative_snackbar--active: #EB565A;
	--vkui--color_onboarding: #2979FA;
	--vkui--color_onboarding--hover: #2775F2;
	--vkui--color_onboarding--active: #2671EB;
	--vkui--color_search_results_alpha: rgba(255, 241, 173, 0.48);
	--vkui--color_search_results_alpha--hover: rgba(255, 241, 173, 0.52);
	--vkui--color_search_results_alpha--active: rgba(255, 241, 173, 0.56);
}
...
.vkui--font_headline3 {
	font-size: var(--vkui--font_headline3--font_size);
	line-height: var(--vkui--font_headline3--line_height);
	font-family: var(--vkui--font_headline3--font_family);
	font-weight: var(--vkui--font_headline3--font_weight);
	font-style: var(--vkui--font_headline3--font_style);
}
...
:root {
	...
	--vkui--font_title2--line_height: 24px;
	...
	--vkui--font_headline3--font_family: VKSansDisplay, MailSans, apple-system, system-ui, "Helvetica Neue", Arial, sans-serif;
