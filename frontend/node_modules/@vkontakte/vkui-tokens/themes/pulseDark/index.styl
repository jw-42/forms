...
vkui-font-media-header--regular() {
...
vkui-font-media-header--compact() {
	font-family: MailSans, Arial, sans-serif;
	font-weight: 500;
	font-size: 40px;
	line-height: 48px;
...
vkui-font-media-title1--regular() {
	font-family: MailSans, Arial, sans-serif;
	font-weight: 500;
	font-size: 28px;
	line-height: 36px;
}
vkui-font-media-title2--regular() {
	font-family: MailSans, Arial, sans-serif;
	font-weight: 500;
	font-size: 24px;
	line-height: 32px;
}
vkui-font-media-title3--regular() {
	font-family: MailSans, Arial, sans-serif;
	font-weight: 500;
	font-size: 20px;
	line-height: 28px;
}
vkui-font-media-lead--regular() {
	font-family: MailSans, Arial, sans-serif;
	font-weight: 500;
	font-size: 19px;
	line-height: 28px;
...
vkui-font-media-paragraph--regular() {
...
vkui-font-media-paragraph--compact() {
	font-family: Georgia, serif;
	font-weight: 400;
	font-size: 19px;
	line-height: 32px;
