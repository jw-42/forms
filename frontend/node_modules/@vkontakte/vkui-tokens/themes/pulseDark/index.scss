$vkui-theme-name: 'pulseDark';
$vkui-theme-name-base: 'pulse';
$vkui-theme-inherits-from: 'paradigm';
$vkui-font-family-accent: MailSans, Arial, sans-serif;
$vkui-font-family-base: Arial, sans-serif;
$vkui-font-family-media: Georgia, serif;
$vkui-font-weight-accent1: 500;
$vkui-font-weight-accent2: 400;
$vkui-font-weight-base1: 700;
$vkui-font-weight-base2: 400;
$vkui-size-field-horizontal-padding--regular: 12px;
$vkui-size-border-radius-small--regular: 4px;
$vkui-size-border-radius--regular: 8px;
$vkui-size-border-radius-large--regular: 12px;
$vkui-size-border-radius-card--regular: 12px;
$vkui-size-border-radius-pill--regular: 100px;
$vkui-size-field-height--regular: 40px;
$vkui-size-button-large-height--regular: 40px;
$vkui-size-button-medium-height--regular: 32px;
$vkui-size-button-small-height--regular: 24px;
$vkui-size-button-circle-large--regular: 44px;
$vkui-size-button-circle-medium--regular: 40px;
$vkui-size-button-circle-small--regular: 32px;
$vkui-size-popup-medium--regular: 360px;
$vkui-size-popup-large--regular: 800px;
$vkui-size-button-padding-horizontal--regular: 12px;
$vkui-size-button-padding-horizontal-large--regular: 16px;
$vkui-size-list-item-height--regular: 44px;
$vkui-size-icon-u-i-medium--regular: 16px;
$vkui-size-icon-u-i-large--regular: 20px;
$vkui-size-avatar-x-s--regular: 24px;
$vkui-size-avatar-s--regular: 32px;
$vkui-size-avatar-m--regular: 40px;
$vkui-size-avatar-l--regular: 60px;
$vkui-size-badge--regular: 20px;
$vkui-size-tag--regular: 24px;
$vkui-size-page-horizontal-padding--regular: 16px;
$vkui-size-cardgrid-gap-space-medium--regular: 16px;
$vkui-size-cardgrid-gap-space-large--regular: 20px;
...
$vkui-pulse-z-index-dropdown: 100px;
$vkui-pulse-z-index-fixed: 120px;
$vkui-pulse-z-index-modal: 140px;
$vkui-pulse-z-index-modal-backdrop: 130px;
$vkui-pulse-z-index-sticky: 110px;
$vkui-pulse-z-index-tooltip: 150px;
$vkui-opacity-disable: 0.48;
$vkui-gradient-skeleton: linear-gradient(110deg, #292929, #383838);
...
$vkui-color-overlay-primary: rgba(0, 0, 0, 0.48);
$vkui-color-overlay-primary--hover: rgba(0, 0, 0, 0.52);
$vkui-color-overlay-primary--active: rgba(0, 0, 0, 0.56);
...
$vkui-color-transparent--hover: rgba(255, 255, 255, 0.08);
$vkui-color-transparent--active: rgba(255, 255, 255, 0.12);
$vkui-color-background-accent-tint-alpha: rgba(0, 95, 249, 0.28);
$vkui-color-background-accent-tint-alpha--hover: rgba(0, 95, 249, 0.32);
$vkui-color-background-accent-tint-alpha--active: rgba(0, 95, 249, 0.36);
$vkui-color-background-negative-tint-alpha: rgba(237, 10, 52, 0.28);
$vkui-color-background-negative-tint-alpha--hover: rgba(237, 10, 52, 0.32);
$vkui-color-background-negative-tint-alpha--active: rgba(237, 10, 52, 0.36);
$vkui-color-background-positive-tint-alpha: rgba(13, 194, 104, 0.28);
$vkui-color-background-positive-tint-alpha--hover: rgba(13, 194, 104, 0.32);
$vkui-color-background-positive-tint-alpha--active: rgba(13, 194, 104, 0.36);
$vkui-color-background-warning-tint-alpha: rgba(255, 158, 0, 0.28);
$vkui-color-background-warning-tint-alpha--hover: rgba(255, 158, 0, 0.32);
$vkui-color-background-warning-tint-alpha--active: rgba(255, 158, 0, 0.36);
$vkui-pulse-color-accent-yellow: #FFD400;
$vkui-pulse-color-accent-yellow--hover: #FFD60A;
$vkui-pulse-color-accent-yellow--active: #FFD714;
$vkui-pulse-color-background-purple: #7960E8;
$vkui-pulse-color-background-purple--hover: #7E66E9;
$vkui-pulse-color-background-purple--active: #846DEA;
$vkui-pulse-color-overlay-viewer: rgba(0, 0, 0, 0.88);
$vkui-pulse-color-overlay-viewer--hover: rgba(0, 0, 0, 0.92);
$vkui-pulse-color-overlay-viewer--active: rgba(0, 0, 0, 0.96);
$vkui-pulse-color-purple-alpha: rgba(234, 226, 255, 0.12);
$vkui-pulse-color-purple-alpha--hover: rgba(234, 226, 255, 0.16);
$vkui-pulse-color-purple-alpha--active: rgba(234, 226, 255, 0.2);
$vkui-pulse-color-white-blue-alpha: rgba(226, 236, 255, 0.12);
$vkui-pulse-color-white-blue-alpha--hover: rgba(226, 236, 255, 0.16);
$vkui-pulse-color-white-blue-alpha--active: rgba(226, 236, 255, 0.2);


@mixin vkui-font-media-header--regular() {
...
$vkui-font-media-header--regular--map: (
...
@mixin vkui-font-media-header--compact() {
	font-family: MailSans, Arial, sans-serif;
	font-weight: 500;
	font-size: 40px;
	line-height: 48px;
...
$vkui-font-media-header--compact--map: (
	'fontFamily': "MailSans, Arial, sans-serif",
	'fontWeight': 500,
	'fontSize': 40px,
	'lineHeight': 48px,
...
@mixin vkui-font-media-title1--regular() {
	font-family: MailSans, Arial, sans-serif;
	font-weight: 500;
	font-size: 28px;
	line-height: 36px;
}
$vkui-font-media-title1--regular--map: (
	'fontFamily': "MailSans, Arial, sans-serif",
	'fontWeight': 500,
	'fontSize': 28px,
	'lineHeight': 36px,
);
@mixin vkui-font-media-title2--regular() {
	font-family: MailSans, Arial, sans-serif;
	font-weight: 500;
	font-size: 24px;
	line-height: 32px;
}
$vkui-font-media-title2--regular--map: (
	'fontFamily': "MailSans, Arial, sans-serif",
	'fontWeight': 500,
	'fontSize': 24px,
	'lineHeight': 32px,
);
@mixin vkui-font-media-title3--regular() {
	font-family: MailSans, Arial, sans-serif;
	font-weight: 500;
	font-size: 20px;
	line-height: 28px;
}
$vkui-font-media-title3--regular--map: (
	'fontFamily': "MailSans, Arial, sans-serif",
	'fontWeight': 500,
	'fontSize': 20px,
	'lineHeight': 28px,
);
@mixin vkui-font-media-lead--regular() {
	font-family: MailSans, Arial, sans-serif;
	font-weight: 500;
	font-size: 19px;
	line-height: 28px;
...
$vkui-font-media-lead--regular--map: (
	'fontFamily': "MailSans, Arial, sans-serif",
	'fontWeight': 500,
	'fontSize': 19px,
	'lineHeight': 28px,
...
@mixin vkui-font-media-lead--compact() {
	font-family: MailSans, Arial, sans-serif;
	font-weight: 500;
	font-size: 22px;
	line-height: 32px;
...
$vkui-font-media-lead--compact--map: (
	'fontFamily': "MailSans, Arial, sans-serif",
	'fontWeight': 500,
	'fontSize': 22px,
	'lineHeight': 32px,
...
@mixin vkui-font-media-paragraph--regular() {
...
$vkui-font-media-paragraph--regular--map: (
...
@mixin vkui-font-media-paragraph--compact() {
	font-family: Georgia, serif;
	font-weight: 400;
	font-size: 19px;
	line-height: 32px;
...
$vkui-font-media-paragraph--compact--map: (
	'fontFamily': "Georgia, serif",
	'fontWeight': 400,
	'fontSize': 19px,
	'lineHeight': 32px,
