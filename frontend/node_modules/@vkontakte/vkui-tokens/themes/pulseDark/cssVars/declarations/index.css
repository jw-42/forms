:root {
	...
	--vkui--elevation1: 0px 16px 48px rgba(0, 0, 0, 0.28);
	--vkui--elevation2: 0px 16px 48px rgba(0, 0, 0, 0.48);
	--vkui--elevation3: 0px 16px 48px rgba(0, 0, 0, 0.64);
	...
	--vkui--gradient_skeleton: linear-gradient(110deg, #292929, #383838);
	...
	--vkui--color_background_accent_tint_alpha: rgba(0, 95, 249, 0.28);
	--vkui--color_background_accent_tint_alpha--hover: rgba(0, 95, 249, 0.32);
	--vkui--color_background_accent_tint_alpha--active: rgba(0, 95, 249, 0.36);
	--vkui--color_background_negative_tint_alpha: rgba(237, 10, 52, 0.28);
	--vkui--color_background_negative_tint_alpha--hover: rgba(237, 10, 52, 0.32);
	--vkui--color_background_negative_tint_alpha--active: rgba(237, 10, 52, 0.36);
	--vkui--color_background_positive_tint_alpha: rgba(13, 194, 104, 0.28);
	--vkui--color_background_positive_tint_alpha--hover: rgba(13, 194, 104, 0.32);
	--vkui--color_background_positive_tint_alpha--active: rgba(13, 194, 104, 0.36);
	--vkui--color_background_warning_tint_alpha: rgba(255, 158, 0, 0.28);
	--vkui--color_background_warning_tint_alpha--hover: rgba(255, 158, 0, 0.32);
	--vkui--color_background_warning_tint_alpha--active: rgba(255, 158, 0, 0.36);
	--vkui--pulse_color_accent_yellow: #FFD400;
	--vkui--pulse_color_accent_yellow--hover: #FFD60A;
	--vkui--pulse_color_accent_yellow--active: #FFD714;
	--vkui--pulse_color_background_purple: #7960E8;
	--vkui--pulse_color_background_purple--hover: #7E66E9;
	--vkui--pulse_color_background_purple--active: #846DEA;
	...
	--vkui--pulse_color_purple_alpha: rgba(234, 226, 255, 0.12);
	--vkui--pulse_color_purple_alpha--hover: rgba(234, 226, 255, 0.16);
	--vkui--pulse_color_purple_alpha--active: rgba(234, 226, 255, 0.2);
	--vkui--pulse_color_white_blue_alpha: rgba(226, 236, 255, 0.12);
	--vkui--pulse_color_white_blue_alpha--hover: rgba(226, 236, 255, 0.16);
	--vkui--pulse_color_white_blue_alpha--active: rgba(226, 236, 255, 0.2);
}
