:root {
	--vkui--theme_name: 'workspaceAdminDark';
	...
	--vkui--theme_name_base: 'workspaceAdminDark';
	...
	--vkui--color_background_tertiary_alpha: rgba(255, 255, 255, 0.04);
	...
	--vkui--color_text_secondary: #BFC1C5;
	--vkui--color_text_secondary--hover: #C2C3C7;
	--vkui--color_text_secondary--active: #C4C6CA;
	...
	--vkui--color_segmented_control: #454546;
	--vkui--color_segmented_control--hover: #4E4E4F;
	--vkui--color_segmented_control--active: #3D3D3E;
	...
	--vkui--color_background_accent_tint_alpha: rgba(0, 119, 255, 0.2);
	--vkui--color_background_accent_tint_alpha--hover: rgba(39, 117, 252, 0.24);
	--vkui--color_background_accent_tint_alpha--active: rgba(39, 117, 252, 0.28);
	...
	--vkui--color_background_warning_tint_alpha: rgba(255, 158, 0, 0.16);
	--vkui--color_background_warning_tint_alpha--hover: rgba(255, 158, 0, 0.24);
	--vkui--color_background_warning_tint_alpha--active: rgba(255, 158, 0, 0.28);
	...
	--vkui--color_background_negative_tint_alpha: rgba(255, 58, 58, 0.24);
	--vkui--color_background_negative_tint_alpha--hover: rgba(255, 58, 58, 0.28);
	--vkui--color_background_negative_tint_alpha--active: rgba(255, 58, 58, 0.32);
	...
	--vkui--color_background_positive_tint_alpha: rgba(13, 194, 104, 0.16);
	--vkui--color_background_positive_tint_alpha--hover: rgba(13, 194, 104, 0.18);
	--vkui--color_background_positive_tint_alpha--active: rgba(13, 194, 104, 0.2);
	...
	--vkui--color_avatars_blue--hover: #5395FF;
	--vkui--color_avatars_blue--active: #5A9AFF;
	--vkui--color_avatars_coral: #FEA4A4;
	--vkui--color_avatars_coral--hover: #FEA8A8;
	--vkui--color_avatars_coral--active: #FEABAB;
	--vkui--color_avatars_green: #43CC4C;
	--vkui--color_avatars_green--hover: #4BCE53;
	--vkui--color_avatars_green--active: #52D05A;
	--vkui--color_avatars_indigo: #7772F8;
	--vkui--color_avatars_indigo--hover: #7C78F8;
	--vkui--color_avatars_indigo--active: #827DF9;
	--vkui--color_avatars_lavender: #D3B2FF;
	--vkui--color_avatars_lavender--hover: #D5B5FF;
	--vkui--color_avatars_lavender--active: #D7B8FF;
	--vkui--color_avatars_lime: #C3F07F;
	--vkui--color_avatars_lime--hover: #C5F184;
	--vkui--color_avatars_lime--active: #C8F189;
	--vkui--color_avatars_mint: #7BEADB;
	--vkui--color_avatars_mint--hover: #80EBDC;
	--vkui--color_avatars_mint--active: #86ECDE;
	--vkui--color_avatars_orange: #F68E42;
	--vkui--color_avatars_orange--hover: #F6934A;
	--vkui--color_avatars_orange--active: #F79751;
	--vkui--color_avatars_peach: #FFB980;
	--vkui--color_avatars_peach--hover: #FFBC85;
	--vkui--color_avatars_peach--active: #FFBF8A;
	--vkui--color_avatars_red: #F55252;
	--vkui--color_avatars_red--hover: #F55959;
	--vkui--color_avatars_red--active: #F66060;
	--vkui--color_avatars_sea: #22CEEC;
	--vkui--color_avatars_sea--hover: #2BD0ED;
	--vkui--color_avatars_sea--active: #34D2EE;
	--vkui--color_avatars_seagreen: #42D7A5;
	--vkui--color_avatars_seagreen--hover: #4AD9A9;
	--vkui--color_avatars_seagreen--active: #51DAAC;
	--vkui--color_avatars_sky: #9EDBFF;
	--vkui--color_avatars_sky--hover: #A2DCFF;
	--vkui--color_avatars_sky--active: #A6DEFF;
	--vkui--color_avatars_violet: #B884FF;
	--vkui--color_avatars_violet--hover: #BB89FF;
	--vkui--color_avatars_violet--active: #BE8EFF;
	--vkui--color_avatars_yellow: #FFD65C;
	--vkui--color_avatars_yellow--hover: #FFD863;
	--vkui--color_avatars_yellow--active: #FFD969;
	--vkui--color_icon_negative_snackbar: #FF5C5C;
	--vkui--color_icon_negative_snackbar--hover: #FF6363;
	--vkui--color_icon_negative_snackbar--active: #FF6969;
	--vkui--color_onboarding: #2979FA;
	--vkui--color_onboarding--hover: #327EFA;
	--vkui--color_onboarding--active: #3A84FA;
	--vkui--color_search_results_alpha: rgba(255, 158, 0, 0.2);
	--vkui--color_search_results_alpha--hover: rgba(255, 158, 0, 0.24);
	--vkui--color_search_results_alpha--active: rgba(255, 158, 0, 0.28);
}
