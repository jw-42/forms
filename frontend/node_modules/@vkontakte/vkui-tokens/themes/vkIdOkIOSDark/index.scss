...
$color-background-accent--hover: #F38910;
$color-background-accent--active: #F58C15;
...
$color-background-accent-tint--hover: #F38E1A;
$color-background-accent-tint--active: #F49223;
$color-background-accent-alternative: #F38910;
$color-background-accent-alternative--hover: #F38E1A;
$color-background-accent-alternative--active: #F49223;
$color-background: #0a0a0a;
$color-background--hover: #141414;
$color-background--active: #1E1E1E;
$color-background-content: #1A1A1C;
$color-background-content--hover: #232325;
$color-background-content--active: #2C2C2E;
...
$color-field-background: #19191A;
$color-field-background--hover: #222223;
$color-field-background--active: #2B2B2C;
...
$color-text-accent--hover: #FF7C0A;
$color-text-accent--active: #FF8214;
...
$color-text-link: #969A9F;
$color-text-link--hover: #9A9EA3;
$color-text-link--active: #9EA2A7;
$color-text-link-themed: #FFFFFF;
$color-text-link-themed--hover: #EBEDF0;
$color-text-link-themed--active: #D7D8DB;
$color-text-link-tint: #76787A;
$color-text-link-tint--hover: #7B7D7F;
$color-text-link-tint--active: #818385;
$color-text-link-visited: #969A9F;
$color-text-link-visited--hover: #9A9EA3;
$color-text-link-visited--active: #9EA2A7;
...
$color-icon-accent--hover: #FF7C0A;
$color-icon-accent--active: #FF8214;
...
$color-icon-primary--hover: #EBEDF0;
$color-icon-primary--active: #D7D8DB;
...
$color-stroke-accent: #505253;
$color-stroke-accent--hover: #57595A;
$color-stroke-accent--active: #5E6061;
...
$color-accent-orange--hover: #FF7C0A;
$color-accent-orange--active: #FF8214;
