:root {
	...
	--vkui--color_text_accent--hover: #FF7C0A;
	--vkui--color_text_accent--active: #FF8214;
	...
	--vkui--color_icon_accent--hover: #FF7C0A;
	--vkui--color_icon_accent--active: #FF8214;
	...
	--vkui--color_accent_orange--hover: #FF7C0A;
	--vkui--color_accent_orange--active: #FF8214;
