:root {
	...
	--vkui--color_background_accent_tint: #0077FF;
	--vkui--color_background_accent_tint--hover: #0073F7;
	--vkui--color_background_accent_tint--active: #006FEF;
	...
	--vkui--color_text_accent: #0077FF;
	--vkui--color_text_accent--hover: #0073F7;
	--vkui--color_text_accent--active: #006FEF;
	--vkui--color_text_accent_themed: #0077FF;
	--vkui--color_text_accent_themed--hover: #0073F7;
	--vkui--color_text_accent_themed--active: #006FEF;
	--vkui--color_text_negative: #ED330A;
	--vkui--color_text_negative--hover: #E4320C;
	--vkui--color_text_negative--active: #DA300E;
	--vkui--color_text_link: #0077FF;
	--vkui--color_text_link--hover: #0073F7;
	--vkui--color_text_link--active: #006FEF;
	--vkui--color_text_link_tint: #71AAEB;
	--vkui--color_text_link_tint--hover: #6CA4E4;
	--vkui--color_text_link_tint--active: #689EDD;
	--vkui--color_text_link_themed: #0077FF;
	--vkui--color_text_link_themed--hover: #0073F7;
	--vkui--color_text_link_themed--active: #006FEF;
	...
	--vkui--color_text_secondary: #93969B;
	--vkui--color_text_secondary--hover: #8D9197;
	--vkui--color_text_secondary--active: #878B93;
	...
	--vkui--color_icon_accent--active: #0077FF;
	...
	--vkui--color_icon_secondary: #B6B8BE;
	--vkui--color_icon_secondary--hover: #AFB1B9;
	--vkui--color_icon_secondary--active: #A7ABB4;
	...
	--vkui--calendar_color_icon_order: #ff54aa;
	--vkui--calendar_color_icon_order--hover: #F551A6;
	--vkui--calendar_color_icon_order--active: #EB4FA1;
	--vkui--calendar_color_icon_finance: #24C780;
	--vkui--calendar_color_icon_finance--hover: #23C07D;
	--vkui--calendar_color_icon_finance--active: #21B87B;
	--vkui--calendar_color_icon_travel: #ba34fc;
	--vkui--calendar_color_icon_travel--hover: #B333F4;
	--vkui--calendar_color_icon_travel--active: #AB31ED;
	--vkui--calendar_color_icon_event: #3BBAFE;
	--vkui--calendar_color_icon_event--hover: #39B3F6;
	--vkui--calendar_color_icon_event--active: #36ACEF;
	--vkui--calendar_color_icon_others: #005FF9;
	--vkui--calendar_color_icon_others--hover: #005CF1;
	--vkui--calendar_color_icon_others--active: #0059EA;
	--vkui--calendar_color_icon_appointment: #FE9898;
	--vkui--calendar_color_icon_appointment--hover: #F49394;
	--vkui--calendar_color_icon_appointment--active: #EA8D91;
	...
	--vkui--calendar_color_button_group_background_positive_tint: #CEF5E8;
	--vkui--calendar_color_button_group_background_positive_tint--hover: #C6ECE1;
	--vkui--calendar_color_button_group_background_positive_tint--active: #BEE3DA;
	--vkui--calendar_color_button_group_background_negative_tint: #FDE2E2;
	--vkui--calendar_color_button_group_background_negative_tint--hover: #F3DADB;
	--vkui--calendar_color_button_group_background_negative_tint--active: #E9D1D5;
	--vkui--calendar_color_button_group_background_accent_tint: #E3F0FD;
	--vkui--calendar_color_button_group_background_accent_tint--hover: #DAE7F5;
	--vkui--calendar_color_button_group_background_accent_tint--active: #D1DEEE;
	--vkui--calendar_color_button_group_text_positive: #056142;
	--vkui--calendar_color_button_group_text_positive--hover: #055E42;
	--vkui--calendar_color_button_group_text_positive--active: #055B42;
	...
	--vkui--calendar_color_sidebar_item_background--hover: rgba(0, 16, 61, 0.04);
	--vkui--calendar_color_sidebar_item_background--active: rgba(0, 16, 61, 0.08);
	...
	--vkui--calendar_color_header_secondary_alpha: rgba(0, 119, 255, 0.1);
	--vkui--calendar_color_header_secondary_alpha--hover: rgba(0, 119, 255, 0.14);
	--vkui--calendar_color_header_secondary_alpha--active: rgba(0, 119, 255, 0.18);
	--vkui--calendar_color_headeron_secondary: #0077FF;
	--vkui--calendar_color_headeron_secondary--hover: #0073F7;
	--vkui--calendar_color_headeron_secondary--active: #006FEF;
	...
	--vkui--calendar_color_text_date_accent: #0077FF;
	--vkui--calendar_color_text_date_accent--hover: #0073F7;
	--vkui--calendar_color_text_date_accent--active: #006FEF;
